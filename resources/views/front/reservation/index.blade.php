                    ...
                    <form method="post" id="register" action="{{ route("reservation.form") }}" class="validateForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4 form-input mt-4">
                                ...
                                <input name="form_checkin" id="form_checkin" class="validate[required] form-control @error('form_checkin') is-invalid @enderror" type="text" value="{{ old('form_checkin') }}">
                            ...
                            <div class="col-12 col-md-4 form-input mt-4">
                                ...
                                <input name="form_checkout" id="form_checkout" class="validate[required] form-control @error('form_checkout') is-invalid @enderror" type="text" value="{{ old('form_checkout') }}">
