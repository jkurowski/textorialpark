        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 text-container text-justify">
                    <b>Textorial Park to nowoczesny park biurowy w Łodzi, zlokalizowany nieopodal centrum miasta, składający sie z 3 budynków biurowych klasy A.</b> Kompleks jest położony na obszarze Księżego Młyna, stanowiącego bardzo ważną dla Łodzi część historyczną i graniczy z zabytkowym Parkiem Źródliska. Bliskość centrum Łodzi, a jednocześnie sąsiedztwo terenów zielonych sprawia, że nieopodal pojawiają się modne lofty oraz restauracje. Kompleks biurowy jest obiektem otwartym, funkcjonującym 24/7.
                    <br><br>
