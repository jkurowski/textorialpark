            ...
            <div class="row">
                <div class="col-12 pl-0">
                    <h4 class="page-title">
                        ...
                        <span class="d-inline-flex me-2 ms-2">/</span>{{$floor->name}} - Warianty
                    </h4>
                </div>
            </div>
        </div>
                            ...
                            <tr id="recordsArray_{{ $p->id }}">
                                ...
                                <td class="option-120">
                                    <div class="btn-group">
                                        ...
                                        <a href="{{route('admin.developro.investment.building.floor.options.edit', [$investment, $building, $floor, $p])}}" class="btn action-button me-1" data-bs-toggle="tooltip" data-placement="top" data-bs-title="Edytuj piętro"><i class="fe-edit"></i></a>
                                        <form method="POST" action="{{route('admin.developro.investment.building.floor.options.destroy', [$investment, $building, $floor, $p])}}">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 d-flex justify-content-end">
                    <a href="{{ route('admin.developro.investment.building.floor.options.create', [$investment, $building, $floor]) }}" class="btn btn-primary">Dodaj wariant</a>
                </div>
            </div>
        </div>
    </div>
