            ...
            <div class="row">
                <div class="col-12 pl-0">
                    <h4 class="page-title">
                        ...
                        <span class="d-inline-flex me-2 ms-2">/</span>{{$building->name}}
                    </h4>
                </div>
            </div>
        </div>
                    ...
                    <table class="table mb-0" id="sortable">
                        ...
                        @foreach ($list as $index => $p)
                            <tr id="recordsArray_{{ $p->id }}">
                                ...
                                <td><a href="{{route('admin.developro.investment.building.floor.options.index', [$investment, $building, $p])}}">{{$p->name}}</a></td>
                                ...
                                <td class="option-120">
                                    <div class="btn-group">
                                        <a href="{{route('admin.developro.investment.building.floor.options.index', [$investment, $building, $p])}}" class="btn action-button me-1" data-bs-toggle="tooltip" data-placement="top" data-bs-title="Pokaż piętro"><i class="fe-folder"></i></a>
                                        ...
                                        <form method="POST" action="{{route('admin.developro.investment.building.floors.destroy', [$investment, $building, $p])}}">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
