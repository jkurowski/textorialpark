    ...
    <div class="container-fluid">
        ...
        <div class="card mt-3">
            <div class="card-body card-body-rem">
                ...
                @if (!directory_exists('/investment/plan/'))
                    <div class="alert alert-danger" role="alert">Katalog '/investment/plan/' w którym umieszczony zostanie plan nie istnieje.</div>
                @endif
